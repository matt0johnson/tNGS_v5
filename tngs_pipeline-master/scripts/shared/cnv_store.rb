class CnvStore
	...
	def process_cnvs(this_sample, this_batch, this_panel, parser)
		phenotype_intervals_path="#{this_batch['base_path']}/#{this_batch['batch_id']}/#{this_panel[1]['intervals_directory']}/#{this_sample.panel_version.downcase}_#{this_sample.phenotype}_variant_calling.bed"
