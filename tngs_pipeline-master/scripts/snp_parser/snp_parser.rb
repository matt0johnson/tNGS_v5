class SnpParser
  ...
  capture_numbers.collect {|capture_number| capture_number.downcase!}
  ...
  snp_array = parser.parse_genotype_table_file("#{this_batch["base_path"]}/#{this_batch["batch_id"]}/variants/t1d.GT.table", capture_numbers)
  ...
  this_book.write "#{this_batch["base_path"]}/#{this_batch["batch_id"]}/variants/#{this_batch["batch_id"]}_T1D_snps.xls"
