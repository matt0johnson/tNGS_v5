...
load("/mnt/Data1/resources/exome_depth_data/v603/v603_exons.RData")
load("/mnt/Data1/resources/exome_depth_data/v603/v603_controls.RData")
...
bed <- '/mnt/Data1/resources/exome_depth_data/v603/v603_CNV_121.bed'
